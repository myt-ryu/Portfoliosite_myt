...
新型コロナウイルスと共に生きる時代において、広くゆったりとした展示空間を生かし、来場者が頭の中に「余白」をつくり、新しい「知」と出合い、未来を変えるひらめきを発見するための場所を提供しました。

「いきつぎの森」「ささやきのベンチ」「はばたきの泉」「ときめきのピアノ」といった複数のゾーンで構成され、映像、科学者の言葉、インタラクティブな演出、AIによる音楽などを通じて、日常を離れた深い思考体験をデザインしました。`,
    role: '制作アシスタント',
    organization: '日本科学未来館',
    achievements: [
      '展示空間の構成・演出の補助',
